import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{N as r,O as i,j as a,l as o,t as s,u as c}from"./utils-I3j1AIuu.js";import{n as l,t as u}from"./NyxDropdownMenu-BoT0H8nJ.js";var d,f,p,m,h,g,_,v,y;e((()=>{t(),l(),c(),s(),d=[{label:`View`,value:`view`,icon:`search`},{label:`Rename`,value:`rename`,icon:`edit`},{label:`Archive`,value:`archive`,disabled:!0,icon:`alert-circle`}],f={title:`Components/NyxDropdownMenu`,component:u,argTypes:{theme:{control:{type:`select`},options:Object.values(a)},variant:{control:{type:`select`},options:Object.values(r)},size:{control:{type:`select`},options:Object.values(i)}}},p=e=>n({components:{NyxDropdownMenu:u},setup(){return{args:e}},template:`
