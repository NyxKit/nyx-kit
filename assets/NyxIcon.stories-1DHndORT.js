import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as r,N as i,c as a,f as o,t as s}from"./utils-BN10c1sN.js";import{n as c,t as l}from"./NyxIcon-BAW9dCtC.js";var u,d,f,p,m,h,g,_,v,y,b;e((()=>{t(),c(),o(),s(),u=[`arrow-right`,`arrow-left`,`chevron-down`,`chevron-up`,`menu`,`x`,`plus`,`minus`,`edit`,`trash`],d={title:`Components/Basic/NyxIcon`,component:l,tags:[`autodocs`],argTypes:{name:{control:{type:`select`},options:u},theme:{control:{type:`select`},options:Object.values(i)},size:{control:{type:`select`},options:Object.values(r)},stroke:{control:{type:`select`},options:Object.values(r)}},parameters:{docs:{description:{component:`A wrapper component for Lucide Vue icons. Supports string-based icon names, optional theme coloring, and size control.
