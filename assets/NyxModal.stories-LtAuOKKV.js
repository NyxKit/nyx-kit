import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,A as n,B as r,E as i,N as a,O as o,Q as s,R as ee,U as c,V as te,Y as l,_ as u,f as d,g as f,h as p,l as m,p as h,t as g,tt as _,v,w as y,y as b,z as ne}from"./vue.esm-bundler-C_Vkk7g_.js";import{N as x,O as S,i as C,j as w,l as T,p as re,r as E,t as D,u as O}from"./utils-I3j1AIuu.js";import{c as ie,o as ae,t as k}from"./composables-DIeLoQQz.js";import{n as A,t as j}from"./NyxButton-2tBI-Q1t.js";var M=e((()=>{})),N,P,F,I,L,R=e((()=>{g(),M(),A(),O(),k(),C(),N=[`aria-labelledby`],P={key:0,class:`nyx-modal__header`},F={class:`nyx-modal__body`},I={key:1,class:`nyx-modal__footer`},L=b({__name:`NyxModal`,props:y({title:{},confirmText:{},cancelText:{default:`Close`},size:{},static:{type:Boolean,default:!1},backdrop:{type:Boolean,default:!0},customClass:{},pixel:{type:Boolean,default:!1},theme:{}},{modelValue:{type:Boolean,default:!1},modelModifiers:{}}),emits:y([`close`,`cancel`,`confirm`,`open`],[`update:modelValue`]),setup(e,{emit:l}){let g=e,y=l,b=ee(e,`modelValue`),S=ne(),C=r(`elDialog`),T=`nyx-modal-title-${E(8)}`,D=d(()=>b.value||g.static),O=d(()=>!!S.header||!!g.title),k=d(()=>!!S.footer||!!g.confirmText),A=d(()=>g.confirmText??`Confirm`),M=d(()=>g.cancelText??`Cancel`),L=[`a[href]`,`button:not([disabled])`,`input:not([disabled])`,`select:not([disabled])`,`textarea:not([disabled])`,`[tabindex]:not([tabindex="-1"])`].join(`, `),R=()=>{C.value?.showModal&&C.value.showModal(),i(()=>{(C.value?.querySelector(L))?.focus()})};o(()=>{D.value&&R()}),te(D,e=>{e?R():C.value?.close&&C.value.close()});let z=()=>{g.static||(b.value=!1,y(`close`))};ie(re.Esc,z);let B=()=>{y(`cancel`),z()},V=()=>{y(`confirm`),z()},{classList:H,nyxTheme:U}=ae(g,{origin:`NyxModal`});return(e,r)=>(n(),f(`dialog`,{class:t([`nyx-modal`,[...s(H),!!g.customClass&&`${g.customClass}`,{"nyx-modal--open":D.value},{"nyx-modal--no-backdrop":!g.backdrop}]]),ref_key:`elDialog`,ref:C,role:`dialog`,"aria-modal":`true`,"aria-labelledby":O.value?T:void 0,onClick:m(z,[`self`]),onCancel:m(z,[`prevent`])},[O.value?(n(),f(`header`,P,[a(e.$slots,`header`,{},()=>[h(`h1`,{id:T},_(g.title),1)]),g.static?p(``,!0):(n(),f(`button`,{key:0,class:`nyx-modal__close`,onClick:z},`×`))])):p(``,!0),h(`section`,F,[a(e.$slots,`default`,{},()=>[r[0]||=u(`NyxModal body`,-1)])]),k.value?(n(),f(`footer`,I,[a(e.$slots,`footer`,{},()=>[v(j,{variant:s(x).Subtle,theme:s(w).Info,onClick:B},{default:c(()=>[u(_(M.value),1)]),_:1},8,[`variant`,`theme`]),v(j,{theme:s(U),variant:s(x).Soft,onClick:V},{default:c(()=>[u(_(A.value),1)]),_:1},8,[`theme`,`variant`])])])):p(``,!0)],42,N))}})})),z,B=e((()=>{R(),R(),z=L,L.__docgenInfo=Object.assign({displayName:L.name??L.__name},{exportName:`default`,displayName:`NyxModal`,description:``,tags:{},props:[{name:`title`,required:!1,type:{name:`string`}},{name:`confirmText`,required:!1,type:{name:`string`}},{name:`cancelText`,required:!1,type:{name:`string`},defaultValue:{func:!1,value:`'Close'`}},{name:`size`,required:!1,type:{name:`NyxSize`}},{name:`static`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`backdrop`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`true`}},{name:`customClass`,required:!1,type:{name:`string`}},{name:`pixel`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`theme`,required:!1,type:{name:`NyxTheme`}}],events:[{name:`close`},{name:`cancel`},{name:`confirm`},{name:`open`}],slots:[{name:`header`},{name:`default`},{name:`footer`}],sourceFiles:[`/home/arnedecant/Projects/nyxkit/nyx-kit/src/components/NyxModal/NyxModal.vue`]})})),V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{g(),B(),O(),D(),A(),V=`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque justo enim, ultrices ac enim ut, placerat facilisis mauris. Cras luctus ante ante, viverra interdum mauris bibendum et. `,H={title:`Components/Feedback/NyxModal`,component:z,argTypes:{size:{control:{type:`select`},options:Object.values(S)},modelValue:{control:{type:`boolean`}}},args:{title:`My Model`}},U=e=>b({components:{NyxModal:z},setup(){let t=l(!0);return{args:e,isOpen:t,onClick:()=>t.value=!0}},template:`
    <div>
  ...
  `}),K=U({}),q=W(`size`,S),J=G(),Y=()=>()=>b({components:{NyxModal:z,NyxButton:j},setup(){let e=l(!1),t=l(w.Primary);return{isOpen:e,currentTheme:t,themes:Object.values(w),openWithTheme:n=>{t.value=n,e.value=!0},lipsum:V}},template:`
    <div class="flex">
      <nyx-button
