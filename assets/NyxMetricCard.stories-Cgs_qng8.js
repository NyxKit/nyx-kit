import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,A as n,Q as r,g as i,h as a,p as o,t as s,tt as c,v as l,y as u}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as d,F as f,N as p,c as m,f as h,t as g}from"./utils-BN10c1sN.js";import{o as _,t as v}from"./composables-D41-uQ7I.js";import{n as y,t as b}from"./NyxIcon-BAW9dCtC.js";var x=e((()=>{})),S,C,w,T,E,D,O,k,A=e((()=>{s(),x(),h(),y(),v(),S={class:`nyx-metric-card__body`},C={class:`nyx-metric-card__title`},w={class:`nyx-metric-card__row`},T={class:`nyx-metric-card__value`},E={key:0,class:`nyx-metric-card__unit`},D={key:1,class:`nyx-metric-card__suffix`},O={key:2,class:`nyx-metric-card__icon`},k=u({__name:`NyxMetricCard`,props:{title:{},value:{},unit:{},suffix:{},theme:{},icon:{},variant:{default:f.Text}},setup(e){let s=e,{classList:u}=_(s,{origin:`NyxMetricCard`});return(f,p)=>(n(),i(`div`,{class:t([`nyx-metric-card`,r(u)])},[o(`div`,S,[o(`div`,C,c(e.title),1),o(`div`,w,[o(`span`,T,c(e.value),1),e.unit?(n(),i(`span`,E,c(e.unit),1)):a(``,!0),e.suffix?(n(),i(`span`,D,c(e.suffix),1)):a(``,!0),e.icon?(n(),i(`span`,O,[l(b,{name:e.icon,theme:s.theme,size:r(d).Small,"aria-hidden":`true`},null,8,[`name`,`theme`,`size`])])):a(``,!0)])])],2))}})})),j,M=e((()=>{A(),A(),j=k,k.__docgenInfo=Object.assign({displayName:k.name??k.__name},{exportName:`default`,displayName:`NyxMetricCard`,description:``,tags:{},props:[{name:`title`,required:!0,type:{name:`string`}},{name:`value`,required:!0,type:{name:`string`}},{name:`unit`,required:!1,type:{name:`string`}},{name:`suffix`,required:!1,type:{name:`string`}},{name:`theme`,required:!1,type:{name:`NyxTheme`}},{name:`icon`,required:!1,type:{name:`string`}},{name:`variant`,required:!1,type:{name:`NyxVariant`},defaultValue:{func:!1,value:`NyxVariant.Text`}}],sourceFiles:[`/home/arnedecant/Projects/nyxkit/nyx-kit/src/components/NyxMetricCard/NyxMetricCard.vue`]})})),N,P,F,I,L,R,z,B,V,H,U,W;e((()=>{s(),M(),h(),g(),N={title:`Components/Data/NyxMetricCard`,component:j,argTypes:{title:{control:`text`},value:{control:`text`},unit:{control:`text`},suffix:{control:`text`},icon:{control:`text`},theme:{control:{type:`select`},options:Object.values(p)},variant:{control:{type:`select`},options:Object.values(f)}}},P=e=>({components:{NyxMetricCard:j},setup(){return{args:e}},template:`<nyx-metric-card v-bind="args" style="width: 220px" />`}),F=(e,t,n)=>()=>u({components:{NyxMetricCard:j},setup(){return{prop:e,values:Object.values(t),getLabel:e=>m(t,e),baseProps:n}},template:`
  ...
  `}),I=Object.assign(P.bind({}),{args:{title:`ACTIVE NODES`,value:`12/12`}}),L=Object.assign(P.bind({}),{args:{title:`SYSTEM UPTIME`,value:`182`,unit:`h`,theme:p.Secondary,variant:f.Soft}}),R=Object.assign(P.bind({}),{args:{title:`ACTIVE NODES`,value:`12/12`,suffix:`STABLE`,theme:p.Success,variant:f.Soft}}),z=Object.assign(P.bind({}),{args:{title:`NETWORK LATENCY`,value:`24`,unit:`ms`,icon:`wifi`,theme:p.Primary,variant:f.Soft}}),B=Object.assign(P.bind({}),{args:{title:`AVG. HUMIDITY`,value:`64`,unit:`%`,suffix:`RISING`,icon:`trending-up`,theme:p.Warning,variant:f.Soft}}),V=F(`variant`,f,{title:`ACTIVE NODES`,value:`12/12`,suffix:`STABLE`,theme:p.Success}),H=F(`theme`,p,{title:`METRIC`,value:`42`,unit:`%`,icon:`activity`,variant:f.Soft}),U=F(`theme`,p,{title:`CPU LOAD`,value:`42`,unit:`%`,icon:`cpu`,variant:f.Filled}),I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`Object.assign(Template.bind({}), {
  args: {
    title: 'ACTIVE NODES',
    value: '12/12'
