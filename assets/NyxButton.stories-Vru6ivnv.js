import{d as v,c as N}from"./vue.esm-bundler-rm72CWhh.js";import{_ as u}from"./NyxButton-uUZ4wFdo.js";import{N as y,a as h,b as e,c as b}from"./common-D9Lon2f2.js";import{g as S}from"./keydict-BK3rIzaC.js";import"./useNyxProps-B_-Cfz1U.js";const _={title:"Components/NyxButton",component:u,argTypes:{type:{control:{type:"select"},options:["button","submit","reset"]},theme:{control:{type:"select"},options:Object.values(e)},gradient:{control:{type:"select"},options:[!0,!1,...Object.values(e)]},backlight:{control:{type:"select"},options:[!0,!1,...Object.values(e)]},variant:{control:{type:"select"},options:Object.values(h)},size:{control:{type:"select"},options:Object.values(y)},shape:{control:{type:"select"},options:Object.values(b)},onClick:{action:"click"}}},k=s=>v({components:{NyxButton:u},setup(){return{args:s}},template:`
