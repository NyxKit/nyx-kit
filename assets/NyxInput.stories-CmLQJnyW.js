import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as r,D as i,h as a,j as o,l as s,t as c,u as l}from"./utils-BWpCgr6y.js";import{i as u,n as d,r as f,t as p}from"./NyxFormField-4Lg2sEgk.js";import{n as m,t as h}from"./NyxInput-BdbuGuvB.js";var g,_,v,y,b,x,S,C,w,T,E,D;e((()=>{t(),m(),l(),c(),u(),d(),g={title:`Components/NyxInput`,component:h,argTypes:{prefix:{control:`text`},suffix:{control:`text`},type:{control:{type:`select`},options:Object.values(a)},theme:{control:{type:`select`},options:Object.values(r)},variant:{control:{type:`select`},options:Object.values(o)},size:{control:{type:`select`},options:Object.values(i)}}},_=e=>n({components:{NyxInput:h},setup(){return{args:e}},template:`
