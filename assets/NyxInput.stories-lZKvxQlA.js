import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{O as r,T as i,k as a,l as o,m as s,t as c,u as l}from"./utils-CVfGrNSp.js";import{i as u,n as d,r as f,t as p}from"./NyxFormField-Dnz2BLJp.js";import{n as m,t as h}from"./NyxInput-joz5E0aL.js";var g,_,v,y,b,x,S,C,w;e((()=>{t(),m(),l(),c(),u(),d(),g={title:`Components/NyxInput`,component:h,argTypes:{type:{control:{type:`select`},options:Object.values(s)},theme:{control:{type:`select`},options:Object.values(r)},variant:{control:{type:`select`},options:Object.values(a)},size:{control:{type:`select`},options:Object.values(i)}}},_=e=>n({components:{NyxInput:h},setup(){return{args:e}},template:`
