import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as r,F as i,N as a,c as o,f as s,t as c}from"./utils-BN10c1sN.js";import{n as l,t as u}from"./NyxDropdownMenu-B5dcSns2.js";var d,f,p,m,h,g,_,v,y;e((()=>{t(),l(),s(),c(),d=[{label:`View`,value:`view`,icon:`search`},{label:`Rename`,value:`rename`,icon:`edit`},{label:`Archive`,value:`archive`,disabled:!0,icon:`alert-circle`}],f={title:`Components/Navigation/NyxDropdownMenu`,component:u,argTypes:{theme:{control:{type:`select`},options:Object.values(a)},variant:{control:{type:`select`},options:Object.values(i)},size:{control:{type:`select`},options:Object.values(r)}}},p=e=>n({components:{NyxDropdownMenu:u},setup(){return{args:e}},template:`
    <div style="padding: 1rem; background: var(--nyx-c-bg-soft);">
      <nyx-dropdown-menu v-bind="args" />
    </div>
  `}),m=p({options:d,theme:a.Primary,size:r.Medium,variant:i.Filled}),h=(e,t)=>()=>n({components:{NyxDropdownMenu:u},setup(){return{prop:e,values:Object.values(t),getLabel:e=>o(t,e),sampleOptions:d}},template:`
  ...
  `}),g=h(`theme`,a),_=h(`variant`,i),v=h(`size`,r),m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`Template({
