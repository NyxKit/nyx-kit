import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,A as n,N as r,Q as i,U as a,_ as o,g as s,h as c,l,m as u,p as d,t as f,y as p}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as m,F as h,N as g,c as _,f as v,k as y,t as b}from"./utils-BN10c1sN.js";import{o as x,t as S}from"./composables-D41-uQ7I.js";import{n as C,t as w}from"./NyxButton-DoetK-17.js";var T=e((()=>{})),E,D=e((()=>{f(),T(),v(),C(),S(),E=p({__name:`NyxBadge`,props:{disabled:{type:Boolean,default:!1},theme:{},variant:{},size:{},hasClose:{type:Boolean,default:!1}},emits:[`click`,`close`],setup(e,{emit:f}){let p=e,m=f,{classList:g}=x(p,{origin:`NyxBadge`,primitive:`badge`});return(f,_)=>(n(),s(`div`,{class:t([`nyx-badge`,[...i(g),{"nyx-badge--closable":e.hasClose}]]),onClick:_[1]||=l(e=>m(`click`),[`self`])},[d(`span`,null,[r(f.$slots,`default`,{},()=>[_[2]||=o(`NyxBadge`,-1)])]),e.hasClose?(n(),u(w,{key:0,class:`nyx-badge__button`,size:p.size,shape:i(y).Circle,variant:i(h).Ghost,onClick:_[0]||=e=>m(`close`)},{default:a(()=>[..._[3]||=[o(`×`,-1)]]),_:1},8,[`size`,`shape`,`variant`])):c(``,!0)],2))}})})),O,k=e((()=>{D(),D(),O=E,E.__docgenInfo=Object.assign({displayName:E.name??E.__name},{exportName:`default`,displayName:`NyxBadge`,description:``,tags:{},props:[{name:`disabled`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`theme`,required:!1,type:{name:`NyxTheme`}},{name:`variant`,required:!1,type:{name:`NyxVariant`}},{name:`size`,required:!1,type:{name:`NyxSize`}},{name:`hasClose`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}}],events:[{name:`click`},{name:`close`}],slots:[{name:`default`}],sourceFiles:[`/home/arnedecant/Projects/nyxkit/nyx-kit/src/components/NyxBadge/NyxBadge.vue`]})})),A,j,M,N,P,F,I,L;e((()=>{f(),k(),v(),b(),A={title:`Components/Basic/NyxBadge`,component:O,argTypes:{theme:{control:{type:`select`},options:Object.values(g)},variant:{control:{type:`select`},options:Object.values(h)},size:{control:{type:`select`},options:Object.values(m)},onClick:{action:`click`}}},j=e=>p({components:{NyxBadge:O},setup(){return{args:e}},template:`
