import{n as e}from"./chunk-BneVvdWh.js";import{Y as t,t as n,y as r}from"./vue.esm-bundler-C_Vkk7g_.js";import{N as i,O as a,f as o,j as s,l as c,t as l,u}from"./utils-I3j1AIuu.js";import{i as d,n as f,r as p,t as m}from"./NyxFormField-DQ5eys5R.js";import{n as h,t as g}from"./NyxSelect-BR6_WVHx.js";var _,v,y,b,x,S,C,w,T,E,D,O,k,A,j,M;e((()=>{n(),h(),u(),l(),d(),f(),_=Object.values(s).map(e=>({label:e,value:e})),v=[{label:`Brand`,options:[{label:`Primary`,value:s.Primary},{label:`Secondary`,value:s.Secondary}]},{label:`Status`,options:[{label:`Info`,value:s.Info},{label:`Success`,value:s.Success},{label:`Warning`,value:s.Warning},{label:`Danger`,value:s.Danger}]}],y={title:`Components/Form/NyxSelect`,component:g,argTypes:{type:{control:{type:`select`},options:Object.values(o)},theme:{control:{type:`select`},options:Object.values(s)},variant:{control:{type:`select`},options:Object.values(i)},size:{control:{type:`select`},options:Object.values(a)}},args:{options:_}},b=e=>r({components:{NyxSelect:g},inheritAttrs:!1,setup(){return{args:e}},template:`
