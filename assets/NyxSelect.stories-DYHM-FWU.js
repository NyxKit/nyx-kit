import{n as e}from"./chunk-BneVvdWh.js";import{Y as t,t as n,y as r}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as i,D as a,M as o,f as s,l as c,t as l,u}from"./utils-BplIUxiH.js";import{i as d,n as f,r as p,t as m}from"./NyxFormField-BeYuPgii.js";import{n as h,t as g}from"./NyxSelect-ButJJ0jQ.js";var _,v,y,b,x,S,C,w,T,E,D,O,k;e((()=>{n(),h(),u(),l(),d(),f(),_=Object.values(i).map(e=>({label:e,value:e})),v=[{label:`Brand`,options:[{label:`Primary`,value:i.Primary},{label:`Secondary`,value:i.Secondary}]},{label:`Status`,options:[{label:`Info`,value:i.Info},{label:`Success`,value:i.Success},{label:`Warning`,value:i.Warning},{label:`Danger`,value:i.Danger}]}],y={title:`Components/NyxSelect`,component:g,argTypes:{type:{control:{type:`select`},options:Object.values(s)},theme:{control:{type:`select`},options:Object.values(i)},variant:{control:{type:`select`},options:Object.values(o)},size:{control:{type:`select`},options:Object.values(a)}},args:{options:_}},b=e=>r({components:{NyxSelect:g},inheritAttrs:!1,setup(){return{args:e}},template:`
  ...
  `}),T=x(`type`,s),E=x(`theme`,i),D=x(`variant`,o),O=x(`size`,a),S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`Template({
  options
