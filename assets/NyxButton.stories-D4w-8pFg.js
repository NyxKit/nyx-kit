import{n as e}from"./chunk-BneVvdWh.js";import{i as t,m as n,x as r}from"./iframe-DbHJjvLx.js";import{D as i,O as a,T as o,l as s,t as c,u as l,w as u}from"./utils-CWkZdHks.js";import{n as d,t as f}from"./NyxButton-6SguUqJT.js";var p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{t(),d(),l(),c(),p={title:`Components/NyxButton`,component:f,argTypes:{type:{control:{type:`select`},options:[`button`,`submit`,`reset`]},theme:{control:{type:`select`},options:Object.values(i)},gradient:{control:{type:`select`},options:[!0,!1,...Object.values(i)]},backlight:{control:{type:`select`},options:[!0,!1,...Object.values(i)]},variant:{control:{type:`select`},options:Object.values(a)},size:{control:{type:`select`},options:Object.values(o)},shape:{control:{type:`select`},options:Object.values(u)},onClick:{action:`click`}}},m=e=>r({components:{NyxButton:f},setup(){return{args:e}},template:`
    <nyx-button v-bind="args" @click="onClick">Button</nyx-button>
  `}),h=(e,t)=>a=>r({components:{NyxButton:f},setup(){return{prop:e,values:Object.values(t),getLabel:e=>s(t,e),isTheme:n(()=>t===i)}},template:`
    <div class="flex">
      <nyx-button
  ...
  `}),g=()=>()=>r({components:{NyxButton:f},setup(){return{themes:Object.values(i),variants:Object.values(a),sizes:Object.values(o),shapes:Object.values(u)}},template:`
    <div class="flex-col">
