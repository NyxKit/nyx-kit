import{n as e}from"./chunk-BneVvdWh.js";import{f as t,t as n,y as r}from"./vue.esm-bundler-C_Vkk7g_.js";import{O as i,T as a,k as o,l as s,t as c,u as l,w as u}from"./utils-CVfGrNSp.js";import{n as d,t as f}from"./NyxButton-_TlOdLFS.js";var p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{n(),d(),l(),c(),p={title:`Components/NyxButton`,component:f,argTypes:{type:{control:{type:`select`},options:[`button`,`submit`,`reset`]},theme:{control:{type:`select`},options:Object.values(i)},gradient:{control:{type:`select`},options:[!0,!1,...Object.values(i)]},backlight:{control:{type:`select`},options:[!0,!1,...Object.values(i)]},variant:{control:{type:`select`},options:Object.values(o)},size:{control:{type:`select`},options:Object.values(a)},shape:{control:{type:`select`},options:Object.values(u)},onClick:{action:`click`}}},m=e=>r({components:{NyxButton:f},setup(){return{args:e}},template:`
