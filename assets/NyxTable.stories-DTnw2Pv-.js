import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as r,F as i,N as a,c as o,f as s,t as c}from"./utils-BN10c1sN.js";import{n as l,t as u}from"./NyxButton-DoetK-17.js";import{n as d,t as f}from"./NyxTable-Bw796R9-.js";var p,m,h,g,_,v,y,b,x,S,C,w;e((()=>{t(),d(),s(),c(),l(),p=[{id:`0`,name:`Lorem`,description:`Lorem ipsum dolor sit amet`},{id:`1`,name:`Ipsum`,description:`Lorem ipsum dolor sit amet`},{id:`2`,name:`Dolor`,description:`Lorem ipsum dolor sit amet`},{id:`3`,name:`Sit`,description:`Lorem ipsum dolor sit amet`},{id:`4`,name:`Amet`,description:`Lorem ipsum dolor sit amet`},{id:`5`,name:`Lorem`,description:`Lorem ipsum dolor sit amet`}],m={title:`Components/Data/NyxTable`,component:f,argTypes:{theme:{control:{type:`select`},options:Object.values(a)},variant:{control:{type:`select`},options:Object.values(i)},size:{control:{type:`select`},options:Object.values(r)}},args:{modelValue:p}},h=e=>n({components:{NyxTable:f},setup(){return{args:e}},template:`
    <nyx-table v-bind="args" />
  `}),g=()=>()=>n({components:{NyxTable:f,NyxButton:u},setup(){return{data:p,NyxSize:r,NyxTheme:a}},template:`
    <nyx-table v-model="data">
      <template #actions="{ item }">
        <nyx-button :size="NyxSize.Xsmall" :theme="NyxTheme.Danger">{{ item.name }}</nyx-button>
      </template>
    </nyx-table>
  `}),_=(e,t)=>()=>n({components:{NyxTable:f,NyxButton:u},setup(){return{prop:e,values:Object.values(t),getLabel:e=>o(t,e),data:p,NyxSize:r,NyxTheme:a,NyxVariant:i}},template:`
  ...
  `}),v=h({}),y=g(),b=()=>n({components:{NyxTable:f,NyxButton:u},setup(){return{data:p,NyxSize:r,NyxTheme:a,alertId:e=>window.alert(e)}},template:`
