import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{O as r,T as i,l as a,t as o,u as s}from"./utils-CVfGrNSp.js";import{n as c,t as l}from"./NyxIcon-NAKUoVN9.js";var u,d,f,p,m,h,g,_,v,y,b;e((()=>{t(),c(),s(),o(),u=[`arrow-right`,`arrow-left`,`chevron-down`,`chevron-up`,`menu`,`x`,`plus`,`minus`,`edit`,`trash`],d={title:`Components/NyxIcon`,component:l,tags:[`autodocs`],argTypes:{name:{control:{type:`select`},options:u},theme:{control:{type:`select`},options:Object.values(r)},size:{control:{type:`select`},options:Object.values(i)},stroke:{control:{type:`select`},options:Object.values(i)}},parameters:{docs:{description:{component:`A wrapper component for Lucide Vue icons. Supports string-based icon names, optional theme coloring, and size control.
...
[View all Lucide icons](https://lucide.dev/icons/)`}}}},f=e=>n({components:{NyxIcon:l},setup(){return{args:e}},template:`<nyx-icon v-bind="args" />`}),p=f({name:`arrow-right`}),m=(e,t)=>()=>n({components:{NyxIcon:l},setup(){return{prop:e,values:Object.values(t),getLabel:e=>a(t,e)}},template:`
  ...
  `}),h=m(`theme`,r),g=m(`size`,i),_=m(`stroke`,i),v=()=>n({components:{NyxIcon:l},setup(){return{sizes:[10,20,32,48,64],ICONS:u}},template:`
    <div>
