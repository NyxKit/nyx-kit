import{n as e}from"./chunk-BneVvdWh.js";import{L as t,M as n,N as r,Q as i,R as a,T as o,X as s,Y as c,Z as l,_ as u,f as d,h as f,i as p,j as m,m as h,v as g,x as _,y as v,z as y}from"./iframe-DbHJjvLx.js";import{D as b,E as x,T as S,f as C,u as w}from"./utils-CWkZdHks.js";import{o as T,t as E}from"./composables-C_x3OoFe.js";var D=e((()=>{})),O,k,A,j,M,N=e((()=>{p(),D(),w(),E(),O=[`id`,`aria-selected`,`aria-controls`,`tabindex`,`onClick`],k={class:`nyx-tabs__container`},A=[`id`,`aria-labelledby`],j={key:0},M=_({__name:`NyxTabs`,props:o({tabs:{},theme:{},size:{},variant:{default:x.Modern},position:{default:C.TopLeft},floating:{type:Boolean,default:!1},border:{type:Boolean,default:!1},tabTransition:{default:`fade`}},{modelValue:{},modelModifiers:{}}),emits:[`update:modelValue`],setup(e){let o=e,p=a(e,`modelValue`),_=y(),{classList:b}=T(o,{origin:`NyxTabs`}),x=h(()=>p.value??o.tabs[0]),S=h(()=>({"--nyx-tab-index":o.tabs.indexOf(x.value)})),C=t(),w=e=>`${C}-tab-${e}`,E=e=>`${C}-panel-${e}`,D=e=>{let t=o.tabs.indexOf(x.value);e.key===`ArrowRight`||e.key===`ArrowDown`?(e.preventDefault(),p.value=o.tabs[(t+1)%o.tabs.length]):e.key===`ArrowLeft`||e.key===`ArrowUp`?(e.preventDefault(),p.value=o.tabs[(t-1+o.tabs.length)%o.tabs.length]):e.key===`Home`?(e.preventDefault(),p.value=o.tabs[0]):e.key===`End`&&(e.preventDefault(),p.value=o.tabs[o.tabs.length-1])};return(t,a)=>(m(),g(`section`,{class:s([`nyx-tabs`,[...c(b),{floating:e.floating,border:e.border}]]),style:l(S.value)},[f(`nav`,null,[f(`ul`,{role:`tablist`,onKeydown:D},[(m(!0),g(d,null,n(e.tabs,e=>(m(),g(`li`,{key:e},[f(`button`,{class:s([`nyx-tabs__button`,{active:e===x.value}]),role:`tab`,id:w(e),"aria-selected":e===x.value,"aria-controls":E(e),tabindex:e===x.value?0:-1,onClick:t=>p.value=e},[r(t.$slots,`tab-button-${e}`,{},()=>[v(i(e),1)])],10,O)]))),128))],32)]),r(t.$slots,`default`),f(`div`,k,[(m(!0),g(d,null,n(e.tabs,e=>(m(),g(`div`,{key:e,class:s([`nyx-tabs__tab`,{active:e===x.value}]),role:`tabpanel`,id:E(e),"aria-labelledby":w(e)},[r(t.$slots,`tab-${e}`,{},()=>[a[0]||=f(`p`,null,`This tab has no content. Add content by using the following template.`,-1),f(`code`,null,i(`<template v-slot:tab-${e}>Your content here</template>`),1)])],10,A))),128))]),c(_).footer?(m(),g(`footer`,j,[r(t.$slots,`footer`)])):u(``,!0)],6))}})})),P,F=e((()=>{N(),N(),P=M,M.__docgenInfo=Object.assign({displayName:M.name??M.__name},{exportName:`default`,displayName:`NyxTabs`,description:``,tags:{},props:[{name:`tabs`,required:!0,type:{name:`Array`,elements:[{name:`string`}]}},{name:`theme`,required:!1,type:{name:`NyxTheme`}},{name:`size`,required:!1,type:{name:`NyxSize`}},{name:`variant`,required:!1,type:{name:`NyxTabsVariant`},defaultValue:{func:!1,value:`NyxTabsVariant.Modern`}},{name:`position`,required:!1,type:{name:`NyxPosition`},defaultValue:{func:!1,value:`NyxPosition.TopLeft`}},{name:`floating`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`border`,required:!1,type:{name:`boolean`},defaultValue:{func:!1,value:`false`}},{name:`tabTransition`,required:!1,type:{name:`union`,elements:[{name:`"none"`},{name:`"fade"`},{name:`"slide-fade"`},{name:`"slide-full"`}]},defaultValue:{func:!1,value:`'fade'`}}],slots:[{name:"`tab-button-${tab}`",scoped:!0,bindings:[{name:`name`,title:`binding`}]},{name:`default`},{name:"`tab-${tab}`",scoped:!0,bindings:[{name:`name`,title:`binding`}]},{name:`footer`}],sourceFiles:[`/home/arnedecant/Projects/nyxkit/nyx-kit/src/components/NyxTabs/NyxTabs.vue`]})})),I,L,R,z,B,V;e((()=>{p(),F(),w(),I=[`profile`,`account`,`settings`],L=Array.from({length:18},(e,t)=>t+1),R=[`Permissions review`,`Connected devices`,`Notification digest`,`Security timeline`,`Export history`,`Automation rules`],z={title:`Components/NyxTabs`,component:P,argTypes:{theme:{control:{type:`select`},options:Object.values(b)},variant:{control:{type:`select`},options:Object.values(x)},size:{control:{type:`select`},options:Object.values(S)}},args:{tabs:I}},B={render:e=>_({components:{NyxTabs:P},setup(){return{args:e,filler:L,checklist:R}},template:`
