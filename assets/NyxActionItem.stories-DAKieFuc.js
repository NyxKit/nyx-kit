import{n as e}from"./chunk-BneVvdWh.js";import{$ as t,A as n,N as r,Q as i,U as a,_ as o,g as s,h as c,m as l,p as u,t as d,tt as f,y as p}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as m,D as h,j as g,u as _}from"./utils-BWpCgr6y.js";import{o as v,t as y}from"./composables-DTmPqnMJ.js";import{n as b,t as x}from"./NyxButton-Bak7Fkne.js";var S=e((()=>{})),C,w,T,E,D,O=e((()=>{d(),S(),_(),y(),b(),C={class:`nyx-action-item__title`},w={class:`nyx-action-item__description`},T={class:`nyx-action-item__description-text`},E={class:`nyx-action-item__action`},D=p({__name:`NyxActionItem`,props:{title:{},theme:{},description:{},action:{}},emits:[`click`],setup(e,{emit:d}){let p=e,m=d,{classList:_}=v(p,{origin:`NyxActionItem`});return(d,v)=>(n(),s(`div`,{class:t([`nyx-action-item`,i(_)])},[u(`span`,C,f(e.title),1),u(`div`,w,[r(d.$slots,`default`,{},()=>[u(`p`,T,f(e.description),1)])]),u(`div`,E,[r(d.$slots,`action`,{},()=>[p.action?(n(),l(x,{key:0,theme:p.theme,size:i(h).Small,variant:i(g).Soft,onClick:v[0]||=e=>m(`click`)},{default:a(()=>[o(f(p.action),1)]),_:1},8,[`theme`,`size`,`variant`])):c(``,!0)])])],2))}})})),k,A=e((()=>{O(),O(),k=D,D.__docgenInfo=Object.assign({displayName:D.name??D.__name},{exportName:`default`,displayName:`NyxActionItem`,description:``,tags:{},props:[{name:`title`,required:!0,type:{name:`string`}},{name:`theme`,required:!1,type:{name:`NyxTheme`}},{name:`description`,required:!1,type:{name:`string`}},{name:`action`,required:!1,type:{name:`string`}}],events:[{name:`click`}],slots:[{name:`default`},{name:`action`}],sourceFiles:[`/home/arnedecant/Projects/nyxkit/nyx-kit/src/components/NyxActionItem/NyxActionItem.vue`]})})),j,M,N,P,F,I,L;e((()=>{d(),A(),_(),j={title:`Components/NyxActionItem`,component:k,argTypes:{theme:{control:{type:`select`},options:Object.values(m)},onClick:{action:`click`}}},M=()=>p({components:{NyxActionItem:k},template:`
    <div>
