import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{A as r,F as i,N as a,f as o}from"./utils-BN10c1sN.js";import{n as s,t as c}from"./NyxButton-DoetK-17.js";import{n as l,t as u}from"./NyxMedia-0sBD3aBd.js";import{n as d,t as f}from"./NyxCard-DlAqMoZz.js";var p,m,h,g,_,v,y;e((()=>{t(),d(),o(),s(),l(),p=`Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis faucibus auctor pellentesque. Sed
  consectetur nulla eget metus consequat vulputate. Nulla venenatis diam dolor, nec ultricies elit cursus a.`,m={title:`Components/Data/NyxCard`,component:f,argTypes:{theme:{control:{type:`select`},options:Object.values(a)},gradient:{control:{type:`select`},options:[!0,!1,...Object.values(a)]},backlight:{control:{type:`select`},options:[!0,!1,...Object.values(a)]},variant:{control:{type:`select`},options:Object.values(i)},size:{control:{type:`select`},options:Object.values(r)},textAlign:{control:{type:`select`},options:[`left`,`center`,`right`,`justify`]},layout:{control:{type:`select`},options:[`media-first`,`header-first`]}},args:{title:`Lorem Ipsum`,src:`https://plus.unsplash.com/premium_photo-1739009671609-f28ec1b83346?q=80&w=3750&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D`,default:p,theme:a.Primary,gradient:a.Success,textAlign:`center`,layout:`header-first`,blendMedia:!0}},h=e=>n({components:{NyxCard:f},setup(){return{args:e}},template:`
    <nyx-card v-bind="args">Card</nyx-card>
  `}),g=e=>()=>n({components:{NyxCard:f,NyxButton:c,NyxMedia:u},setup(){return{args:e,lipsum:p,NyxTheme:a,NyxSize:r,NyxVariant:i}},template:`
    <nyx-card
      v-bind="args"
      title="Lorem Ipsum"
      textAlign="center"
