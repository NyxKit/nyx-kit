import{n as e}from"./chunk-BneVvdWh.js";import{t,y as n}from"./vue.esm-bundler-C_Vkk7g_.js";import{D as r,O as i,T as a,l as o,m as s,t as c,u as l}from"./utils-CWkZdHks.js";import{i as u,n as d,r as f,t as p}from"./NyxFormField-DUcC2BUu.js";import{n as m,t as h}from"./NyxInput-RE-HgdL3.js";var g,_,v,y,b,x,S,C,w;e((()=>{t(),m(),l(),c(),u(),d(),g={title:`Components/NyxInput`,component:h,argTypes:{type:{control:{type:`select`},options:Object.values(s)},theme:{control:{type:`select`},options:Object.values(r)},variant:{control:{type:`select`},options:Object.values(i)},size:{control:{type:`select`},options:Object.values(a)}}},_=e=>n({components:{NyxInput:h},setup(){return{args:e}},template:`
