import{n as e}from"./chunk-BneVvdWh.js";import{f as t,t as n,y as r}from"./vue.esm-bundler-C_Vkk7g_.js";import{D as i,N as a,O as o,j as s,l as c,t as l,u}from"./utils-I3j1AIuu.js";import{n as d,t as f}from"./NyxButton-DhWB_Sho.js";var p,m,h,g,_,v,y,b,x,S,C,w,T;e((()=>{n(),d(),u(),l(),p={title:`Components/NyxButton`,component:f,argTypes:{type:{control:{type:`select`},options:[`button`,`submit`,`reset`]},theme:{control:{type:`select`},options:Object.values(s)},gradient:{control:{type:`select`},options:[!0,!1,...Object.values(s)]},backlight:{control:{type:`select`},options:[!0,!1,...Object.values(s)]},variant:{control:{type:`select`},options:Object.values(a)},size:{control:{type:`select`},options:Object.values(o)},shape:{control:{type:`select`},options:Object.values(i)},onClick:{action:`click`}}},m=e=>r({components:{NyxButton:f},setup(){return{args:e}},template:`
